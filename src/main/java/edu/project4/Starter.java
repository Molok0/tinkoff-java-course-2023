...
public class Starter {
    ...
    public static void start() {
        ...
        MultithreadedRenderer multithreadedRenderer = new MultithreadedRenderer(affineCoefficients, THREADS_COUNT);
...
//            new Swirl()
        ...
        var fractalMul = multithreadedRenderer.render(canvas, world, transformations, SAMPLES, ITER_PER_SAMPLE, SEED);
        gammaCorrectionProcessor.process(fractalMul);
        ImageUtils.save(
            fractalMul,
